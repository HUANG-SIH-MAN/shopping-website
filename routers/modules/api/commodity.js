...
router.post('/like/:id', authenticated, paramsChecker,commodityController.likeCommodity)
router.delete('/unlike/:id', authenticated, paramsChecker,commodityController.unlikeCommodity)
